...
export const FlashcardsApiService = {
   ...
   */
  async list(query: ListFlashcardsQuery): Promise<PaginatedFlashcardsResponse> {
   ...
   * @throws Error jeśli request się nie powiedzie
   */
  async create(data: FlashcardFormData): Promise<CreateFlashcardsResponse> {
   ...
   * @throws Error jeśli request się nie powiedzie
   */
  async update(id: string, data: FlashcardFormData): Promise<FlashcardDto> {
    // Prepare command with trimmed data
